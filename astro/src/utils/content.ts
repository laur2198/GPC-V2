...
export const copy: Record<Locale, LocaleCopy> = {
  ro: {
    home: {
      meta: { title: 'Green Phoenix Concept — Performanță digitală', description: 'Agenție de marketing digital: ads și site-uri care convertesc.' },
    ...
    'servicii-ads': {
      meta: { title: 'Servicii Ads — Green Phoenix Concept', description: 'Campanii Google Ads, Meta Ads și TikTok Ads pentru rezultate măsurabile.' },
    ...
    'servicii-web': {
      meta: { title: 'Servicii Web — Green Phoenix Concept', description: 'Site-uri și landing pages performante, optimizate pentru conversie.' },
      hero: { title: 'Site-uri web care convertesc', subtitle: 'Design rapid, SEO tehnic și UX bazat pe date.', ctaLabel: 'Solicită proiect' },
    },
    despre: {
      meta: { title: 'Despre noi — Green Phoenix Concept', description: 'Cine suntem și de ce facem ce facem.' },
      hero: { title: 'Despre Green Phoenix Concept', subtitle: 'O echipă focusată pe rezultate, nu pe vanity metrics.', ctaLabel: 'Vorbește cu noi' },
    },
    contact: {
      meta: { title: 'Contact — Green Phoenix Concept', description: 'Discută cu echipa noastră.' },
      hero: { title: 'Hai să vorbim', subtitle: 'Programează un audit gratuit sau cere o ofertă personalizată.', ctaLabel: 'Trimite mesaj' },
    },
    politica: {
      meta: { title: 'Politică de confidențialitate', description: 'Politica de confidențialitate Green Phoenix Concept.' },
      hero: { title: 'Politică de confidențialitate', subtitle: 'Cum colectăm, folosim și protejăm datele tale.', ctaLabel: '' },
    },
    portofoliu: {
      meta: { title: 'Portofoliu — Green Phoenix Concept', description: 'Studii de caz și proiecte realizate.' },
      hero: { title: 'Proiectele noastre', subtitle: 'Rezultate reale pentru clienți reali.', ctaLabel: '' },
    },
    blog: {
      meta: { title: 'Blog — Green Phoenix Concept', description: 'Articole despre marketing digital, ads și optimizare web.' },
      hero: { title: 'Blog', subtitle: 'Insight-uri, ghiduri și studii de caz.', ctaLabel: '' },
    },
  },
  en: {
    home: {
      meta: { title: 'Green Phoenix Concept — Digital performance', description: 'Digital marketing agency: ads and websites that convert.' },
    ...
    'servicii-ads': {
      meta: { title: 'Ads Services — Green Phoenix Concept', description: 'Google Ads, Meta Ads and TikTok Ads campaigns with measurable results.' },
    ...
    'servicii-web': {
      meta: { title: 'Web Services — Green Phoenix Concept', description: 'High-performance websites and landing pages optimized for conversion.' },
      hero: { title: 'Websites that convert', subtitle: 'Fast design, technical SEO and data-driven UX.', ctaLabel: 'Start a project' },
    },
    despre: {
      meta: { title: 'About — Green Phoenix Concept', description: 'Who we are and why we do what we do.' },
      hero: { title: 'About Green Phoenix Concept', subtitle: 'A team focused on results, not vanity metrics.', ctaLabel: 'Talk to us' },
    },
    contact: {
      meta: { title: 'Contact — Green Phoenix Concept', description: 'Talk to our team.' },
      hero: { title: 'Let’s talk', subtitle: 'Book a free audit or request a custom quote.', ctaLabel: 'Send a message' },
    },
    politica: {
      meta: { title: 'Privacy policy', description: 'Green Phoenix Concept privacy policy.' },
      hero: { title: 'Privacy policy', subtitle: 'How we collect, use and protect your data.', ctaLabel: '' },
    },
    portofoliu: {
      meta: { title: 'Portfolio — Green Phoenix Concept', description: 'Case studies and completed projects.' },
      hero: { title: 'Our work', subtitle: 'Real results for real clients.', ctaLabel: '' },
    },
    blog: {
      meta: { title: 'Blog — Green Phoenix Concept', description: 'Articles on digital marketing, ads and web optimization.' },
      hero: { title: 'Blog', subtitle: 'Insights, guides and case studies.', ctaLabel: '' },
    },
  },
  it: {
    home: {
      meta: { title: 'Green Phoenix Concept — Performance digitale', description: 'Agenzia di marketing digitale: ads e siti che convertono.' },
    ...
    'servicii-ads': {
      meta: { title: 'Servizi Ads — Green Phoenix Concept', description: 'Campagne Google Ads, Meta Ads e TikTok Ads con risultati misurabili.' },
    ...
    'servicii-web': {
      meta: { title: 'Servizi Web — Green Phoenix Concept', description: 'Siti e landing page ad alte performance ottimizzati per la conversione.' },
      hero: { title: 'Siti che convertono', subtitle: 'Design veloce, SEO tecnica e UX basata sui dati.', ctaLabel: 'Avvia un progetto' },
    },
    despre: {
      meta: { title: 'Chi siamo — Green Phoenix Concept', description: 'Chi siamo e perché facciamo quello che facciamo.' },
      hero: { title: 'Chi siamo', subtitle: 'Un team focalizzato sui risultati, non sulle vanity metrics.', ctaLabel: 'Parla con noi' },
    },
    contact: {
      meta: { title: 'Contatti — Green Phoenix Concept', description: 'Parla con il nostro team.' },
    ...
    politica: {
      meta: { title: 'Informativa sulla privacy', description: 'Informativa sulla privacy di Green Phoenix Concept.' },
      hero: { title: 'Informativa sulla privacy', subtitle: 'Come raccogliamo, usiamo e proteggiamo i tuoi dati.', ctaLabel: '' },
    },
    portofoliu: {
      meta: { title: 'Portfolio — Green Phoenix Concept', description: 'Case study e progetti realizzati.' },
      hero: { title: 'I nostri progetti', subtitle: 'Risultati reali per clienti reali.', ctaLabel: '' },
    },
    blog: {
      meta: { title: 'Blog — Green Phoenix Concept', description: 'Articoli su marketing digitale, ads e ottimizzazione web.' },
